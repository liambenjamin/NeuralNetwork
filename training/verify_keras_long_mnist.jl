...
KERAS_WEIGHTS = npzread("mnist-params/keras-rnn-mnist-adam.npz")
...
# load ntwk gradients
KERAS_GRADS = npzread("mnist-params/keras-rnn-mnist-adam-grad.npz")
...
VERIFY_PAIR = npzread("mnist-params/keras-rnn-mnist-test-pair.npz")
